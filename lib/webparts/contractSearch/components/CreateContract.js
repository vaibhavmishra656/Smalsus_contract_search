...
var CreateContract = function (prop) {
    ...
    return (React.createElement("div", { className: "modal show", style: { display: 'block', position: 'initial' } },
        React.createElement(Panel, { headerText: "Create Contract", isOpen: show, onDismiss: handleClose, isFooterAtBottom: true },
        ...
        React.createElement(Panel, { headerText: "Contacts", isOpen: ContactDetailspopup, onDismiss: function () { return poupcloseContractType("contact"); }, isFooterAtBottom: true },
            React.createElement(React.Fragment, null,
