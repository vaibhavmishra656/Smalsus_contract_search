...
var CreateContract = function (prop) {
    ...
    var _p = useState(false), search = _p[0], setsearch = _p[1];
    var _q = useState([]), employeedataa = _q[0], setemployeedataa = _q[1];
    ...
    var LoadSmartTaxonomy = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    web = new Web('https://hhhhteams.sharepoint.com/sites/HHHH');
    ...
    var loadContactDetails = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    web = new Web('https://hhhhteams.sharepoint.com/sites/HHHH/Smalsus');
    ...
    var searchcontact = function (e) {
        ...
        if (key.length > 0) {
            setsearch(true);
            var filterAll = employeedataa.filter(function (items) { var _a; return (_a = items.FullName) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(key); });
    ...
    return (React.createElement("div", { className: "modal show", style: { display: 'block', position: 'initial' } },
        React.createElement(Panel, { headerText: "Create Contract", isOpen: show, onDismiss: handleClose, isFooterAtBottom: true, isBlocking: !contractTypepopup && !ContactDetailspopup },
            React.createElement(React.Fragment, null,
                React.createElement(Form, null,
                    React.createElement(Row, { className: " ms-Panel--lg" },
                        React.createElement(Form.Group, null,
                            React.createElement(Form.Label, null, "Title"),
                            React.createElement("input", { type: "text", className: "space form-control", "aria-label": "Small", "aria-describedby": "inputGroup-sizing-sm", onChange: function (e) { return setTitlecontract(e.target.value); } })),
                        React.createElement(Form.Group, null,
                            React.createElement(Form.Label, null, "Employee Name"),
                            React.createElement("div", null,
                                React.createElement("input", { type: "text", className: "space form-control", "aria-label": "Small", "aria-describedby": "inputGroup-sizing-sm", value: ContactDetailsItem }),
                        ...
                        React.createElement(Form.Group, null,
                            ...
                            React.createElement("div", null,
                                React.createElement("input", { type: "text", className: "space form-control", "aria-label": "Small", "aria-describedby": "inputGroup-sizing-sm", value: contractTypeItem }),
            ...
            React.createElement("div", { className: "buttons" },
                React.createElement(Button, { className: "btmbtn", variant: "primary", onClick: handleClose }, "Add New Employee"),
                React.createElement(Button, { variant: "primary", className: "btmbtn", onClick: createnewcontract }, "Create"),
                React.createElement(Button, { variant: "secondary", className: "btmbtn", onClick: handleClose }, "Close"))),
        React.createElement(Panel, { headerText: "Contract Type", isOpen: contractTypepopup, onDismiss: function () { return poupcloseContractType("contract"); }, isFooterAtBottom: true },
            ...
            React.createElement("div", { className: "buttons" },
                React.createElement(Button, { variant: "primary", className: "btmbtn", onClick: function () { return saveContractType(checkContractitem, "contract"); } }, "save"),
                React.createElement(Button, { variant: "secondary", className: "btmbtn", onClick: function () { return poupcloseContractType("contract"); } }, "Cancel"))),
        React.createElement(Panel, { headerText: "Contacts ".concat(name), isOpen: ContactDetailspopup, onDismiss: function () { return poupcloseContractType("contact"); } },
            React.createElement(React.Fragment, null,
                React.createElement("input", { type: "text", className: "main-search", placeholder: " Search All", onChange: function (e) { return searchcontact(e); } })),
            search ? React.createElement("div", { className: 'bodypoup col-sm-12 row' }, ContactsDetails.map(function (item, index) {
                return (React.createElement("div", { className: "radio col-sm-4" },
                    React.createElement("div", { key: index },
                        " ",
            ...
            React.createElement("div", { className: "buttons" },
                React.createElement(Button, { variant: "primary", className: "btmbtn", onClick: function () { return saveContractType(checkContactitem, "contact"); } }, "save"),
                React.createElement(Button, { variant: "secondary", className: "btmbtn", onClick: function () { return poupcloseContractType("contact"); } }, "Cancel")))));
};
