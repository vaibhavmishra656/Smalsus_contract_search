    ...
    return (React.createElement("div", { className: 'contact-section' },
        React.createElement("div", { className: 'cotact-container' },
            ...
            React.createElement("div", null,
                React.createElement("div", { className: "card-header d-flex justify-content-between", style: { width: "140%" } },
                    React.createElement("div", null,
                ...
                React.createElement("tbody", { ref: componentLongRef }, AllContacts.map(function (item, index) {
                    return (React.createElement("tr", { key: index },
                        ...
                        React.createElement("td", { className: 'full-name' },
                            React.createElement("a", { href: "https://hhhhteams.sharepoint.com/sites/HHHH/Smalsus/SitePages/Contract-Profile-SPFx.aspx?SmartID=".concat(item.Id), target: "_blank" }, item.Title)),
